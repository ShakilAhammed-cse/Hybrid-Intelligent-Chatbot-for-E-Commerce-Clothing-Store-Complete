...
<!-- CHAT POPUP -->
<div class="chat-widget" id="chatPopup">
  <div class="chat-header">
    <div class="chat-title">
      <div class="chat-avatar">A</div>
      <div>
        <div class="chat-name">Arroway Assistant</div>
        <div class="chat-sub">Ask about size • price • availability</div>
      </div>
    </div>
  ...
  <div class="chat-body" id="chat-box">
    <div class="bubble bot">👋 Hi! I’m here to help you shop.</div>
    <div class="bubble bot">Try: “Do you have Product A size M?”</div>
  </div>
